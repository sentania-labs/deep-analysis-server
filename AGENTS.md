# AGENTS.md — deep-analysis-server

This file is authoritative for all agent sessions working in this repo (CLAUDE.md is a pointer to it). Read it before taking any action. Cross-reference the approved plan at `/home/scott/.claude/plans/steady-dazzling-charm.md`.
