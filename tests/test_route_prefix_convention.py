...
_WEB_BROWSER_PATHS = frozenset(
    {
        ...
        "/dashboard/partials/preboard-postboard",
        "/dashboard/partials/mulligans",
        ...
        "/profile/agents/{agent_id}/reparse",
        ...
        "/admin/users/{user_id}/toggle-role",
        "/admin/users/{user_id}/toggle-disabled",
        "/admin/users/{user_id}/revoke-sessions",
        "/admin/users/{user_id}/reparse",
        "/admin/agents",
        "/admin/agents/{agent_id}/reparse",
        "/admin/agents/{agent_id}/revoke",
        "/admin/agents/{agent_id}/rotate-key",
        "/admin/agents/{agent_id}/delete",
        "/admin/agents/reparse-all",
        "/admin/agents/cleanup-stale",
        "/admin/invites",
        "/admin/invites/{invite_id}/revoke",
        "/admin/settings",
        "/admin/settings/registration-mode",
        "/admin/settings/scrape-mtgo",
        "/admin/settings/scrape-mtgtop8",
        "/admin/settings/tunables",
        "/admin/scrapers",
        "/admin/scrapers/{name}/events",
        "/admin/scrapers/{name}/events/{event_id}",
        "/admin/scrapers/{name}/toggle",
        "/admin/scrapers/{name}/interval",
        "/admin/scrapers/{name}/trigger",
        "/admin/scrapers/{name}/reset",
        "/admin/matches",
        "/admin/archetypes",
        "/admin/archetypes/new",
        "/admin/archetypes/create",
        "/admin/archetypes/{archetype_id}/edit",
        "/admin/archetypes/{archetype_id}/delete",
        "/admin/cards",
        "/admin/cards/sync",
        "/register",
        "/cards",
        "/metagame",
        "/metagame/api/tiers/{format_name}",
        "/metagame/api/trends/{format_name}",
        "/metagame/{format_name}",
        "/metagame/{format_name}/events/{source}/{event_id}",
        "/matches/{match_id}",
